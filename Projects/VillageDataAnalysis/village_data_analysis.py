# -*- coding: utf-8 -*-
"""Village_Data_Analysis.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1DhJ24Q7zqeBa7BULv1icU2XfpE2a-6DC
"""
...
ages = np.random.randint(0, 100, size=num_citizens)
genders = np.random.choice(['Male', 'Female'], size=num_citizens)
marital_status = np.random.choice(['Married','Single'],size=num_citizens)
educational_status = np.random.choice(['High School','Bachelor','Master','PhD'],size=num_citizens)
religion = np.random.choice(['Islam','Christianity','Hinduism','Buddhism','Other'],size=num_citizens)
...
village_data = pd.DataFrame({
    ...
    'Religion':religion,
    'Eligible to Vote':ekigible_to_vote
})
